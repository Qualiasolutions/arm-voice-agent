...
// Helper function for concise checking phrases
...
async function searchUploadedProducts(searchTerm, language, context) {
  ...
  try {
    ...
    const searchInstruction = `Find products matching "${searchTerm}". 
    Return product name, price in euros, and availability.
    Be direct and concise. Always mention prices in euros (€).
    If multiple products match, show the top 3 options.
    End with: "You can visit our store at 171 Makarios Avenue or order at armenius.com.cy"`;
